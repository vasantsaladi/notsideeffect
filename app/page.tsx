        ...
        <div className="card-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm mb-4">
                Analysis: Many users report difficulties with sleep, indicating
                a significant negative impact on their well-being.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-4 text-sm">
                ...
                can increase the risk of psychosis or mania by more than
                fivefold.
              </p>
